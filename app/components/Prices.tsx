...
const cards = [
	{
		...
		items: [
			{
				label: "Állapotfelmérés Budapest XII. ker. (1–1,5 óra)",
				price: "45 000 Ft",
	...
	},
	{
		...
		items: [
			{ label: "Budapest XII. ker.", price: "20 000 Ft", info: "" },
			{ label: "Győr", price: "20 000 Ft", info: "" },
			{
				label: "Dunaszerdahely (SK)",
				price: "65 €",
				info: "",
			},
		],
	...
	},
	{
		...
		items: [
			...
			{ label: "Budapest XII. ker.", price: "20 000 Ft", info: "" },
			{ label: "Győr", price: "20 000 Ft", info: "" },
			{ label: "Dunaszerdahely (SK)", price: "65 €", info: "" },
		],
